...
public class HandlerScan extends AppCompatActivity {
    ...
    private void getImages() {
        imagesPath.add(R.drawable.btn1);
        imagesPath.add(R.drawable.btn2);

        namesPath.add("Normal");
        namesPath.add("Kembung");

        modelNames.add("normal.sfb");
        modelNames.add("kembung.sfb");
